...
public class B2bFileUtil {
	...
	public static void execute(String path, String rootFolder,String webFolder) throws Exception {
		...
		while ((line = reader.readLine()) != null) {
			...
			copyFile(line.trim(), rootFolder, webFolder);
		}
		reader.close();
	...
	// 将文件复制到指定的文件夹中
	private static void copyFile(String file, String rootFolder,String webFolder) {
		...
		if (file.contains("/src/")) { // 处理Java文件
			file = file.replace("/src/", "/" + webFolder + "/WEB-INF/classes/");

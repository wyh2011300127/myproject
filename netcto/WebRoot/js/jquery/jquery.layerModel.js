...
(function($) {
	...
	var methods = {
		...
		init : function(data, options) {
			...
			var defaults = {center:true,locked:true,fixed:true,drag:true,zIndex:9999,opacity:"0.5",title:"系统提示",width:0,height:0,timer:0,bgColor:"#999",left:350,top:100,head:true,isClose:true,
					close : function(){
						return true;
					}
				};
